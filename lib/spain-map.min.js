...
,number:6}],window.SpainMap=function(t){var n,r,i,s,o,u,a;n=Raphael(t.id,t.width,t.height),r={fill:t.fillColor||"#d3d3d3",stroke:t.strokeColor||"#fff","stroke-width":t.strokeWidth||"0.75"},i=function(e){var i;i=n.path(e.path).attr(r),delete e.path,i[0].style.cursor="pointer",i[0].onmouseover=function(r){i.attr({fill:t.selectedColor}),n.safari();if(t.onMouseOver)return t.onMouseOver(e,r)},i[0].onmouseout=function(r){i.animate({fill:t.fillColor},t.animationDuration||500),n.safari();if(t.onMouseOut)return t.onMouseOut(e,r)};if(t.onClick)return i[0].onclick=function(n){return t.onClick(e,n)}};for(u=0,a=e.length;u<a;u++)o=e[u],i(o);return s={x:150.522,y:11.305,width:416.74600000000004,height:348.17},n.setViewBox(s.x,s.y,s.width,s.height,!0),e=null}}).call(this);