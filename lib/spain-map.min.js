...
,number:6}],window.SpainMap=function(t){var n,r,i,s,o,u,a,f;n=Raphael(t.id,t.width,t.height),r={fill:t.fillColor||"#d3d3d3",stroke:t.strokeColor||"#fff","stroke-width":t.strokeWidth||"0.75"},s=function(e){var i;i=n.path(e.path).attr(r),delete e.path,i[0].style.cursor="pointer",i[0].onmouseover=function(){i.attr({fill:t.selectedColor}),n.safari();if(t.onMouseOver)return t.onMouseOver(e)},i[0].onmouseout=function(){return i.animate({fill:t.fillColor},t.animationDuration||500),n.safari()};if(t.onClick)return i[0].onclick=function(){return t.onClick(e)}},n.setStart();for(a=0,f=e.length;a<f;a++)o=e[a],s(o);return u=n.setFinish(),i=u.getBBox(!0),n.setViewBox(i.x,i.y,i.width,i.height,!0),e=null}}).call(this);